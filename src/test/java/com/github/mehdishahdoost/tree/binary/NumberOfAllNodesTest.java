...
public class NumberOfAllNodesTest {
    ...
    public void numberOfNodes() {
        NumberOfAllNodes numberOfAllNodesTest = new NumberOfAllNodes();
        int sumOfAllNodes1 = numberOfAllNodesTest.getNumberOfAllNodes(root);
        Assertions.assertEquals(sumOfAllNodes1, 9);
    }
